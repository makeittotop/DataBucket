...
package io.abhishekpareek.devauth.client;
...
public class AmazonCognitoSampleDeveloperAuthenticationClient {
     ...
     */
    public io.abhishekpareek.devauth.client.Response getToken(Map<String, String> logins, String identityId) {
        String uid = io.abhishekpareek.devauth.client.AmazonSharedPreferencesWrapper
                .getUidForDevice(this.sharedPreferences);
        String key = io.abhishekpareek.devauth.client.AmazonSharedPreferencesWrapper
                .getKeyForDevice(this.sharedPreferences);

        io.abhishekpareek.devauth.client.Request getTokenRequest = new io.abhishekpareek.devauth.client.GetTokenRequest(this.endpoint,
